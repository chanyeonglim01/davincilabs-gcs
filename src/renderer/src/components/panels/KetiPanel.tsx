      ...
      {!collapsed && (
        <div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr' }}>
            <DataCell label="DIST" value={distance.toFixed(1)} unit="m" />
            <DataCell label="SIZE" value={size.toFixed(1)} unit="" />
            <DataCell label="OBJ X" value={objX.toFixed(1)} unit="m" />
            <DataCell label="OBJ Y" value={objY.toFixed(1)} unit="m" />
            <DataCell label="OBJ Z" value={objZ.toFixed(1)} unit="m" />
            <DataCell label="TYPE" value={String(id)} unit="" />
          </div>
        </div>
      )}
    </div>
